...
// Constants
const TWITTER_HANDLE = "rseromenho";
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
// Add the domain you will be minting
const tld = ".profile";
const CONTRACT_ADDRESS = "0x43948153884512DE4285D4c04900d8caC07C2dDf";
  ...
  const mintDomain = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        let tx
        try {
          tx = await contract.register(domain, {
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">👤 Profile Name Service</p>
              <p className="subtitle">
                Your immortal .profile on the blockchain!
              </p>
            </div>
